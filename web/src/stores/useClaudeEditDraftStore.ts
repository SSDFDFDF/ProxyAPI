 ...
 *
 * Why this exists:
 * - Entering `/ai-providers/claude/.../models` moves to a sibling route, so component-local state
 *   inside the Claude edit layout is not shared between the edit screen and the model picker screen.
 * - This store makes the Claude edit draft shared across related routes keyed by provider index/new.
 */
