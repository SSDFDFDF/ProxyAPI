 ...
 *
 * Why this exists:
 * - Entering `/ai-providers/openai/.../models` moves to a sibling route, so component-local state
 *   inside the OpenAI edit layout is not shared between the edit screen and the model picker screen.
 * - This store makes the OpenAI edit draft shared across related routes keyed by provider index/new.
 */
