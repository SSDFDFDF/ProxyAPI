...
export const QUOTA_REQUEST_TIMEOUT_MS = 90 * 1000;
export const QUOTA_REFRESH_CONCURRENCY = 3;
export const QUOTA_AUTO_REFRESH_INTERVAL_MS = 60 * 1000;
export const QUOTA_AUTO_REFRESH_MAX_BACKOFF_MS = 5 * 60 * 1000;
...
export const STORAGE_KEY_QUOTA_AUTO_REFRESH = 'cli-proxy-quota-auto-refresh';
