      ...
      <div className={styles.content}>
        <div className={styles.heroSection}>
          <div className={styles.heroHeader}>
            ...
            <h2 className={styles.heroTitle}>{t('system_info.about_title')}</h2>
          </div>

          <div className={styles.heroBadges}>
            <button type="button" className={styles.heroBadge} onClick={handleInfoVersionTap}>
              <span className={styles.badgeLabel}>UI</span> {appVersion}
            </button>

            <button
              type="button"
              className={`${styles.heroBadge} ${checkingVersion ? styles.loading : ''}`}
              onClick={() => void handleVersionCheck()}
              title={t('system_info.version_check_button')}
            >
              <span className={styles.badgeLabel}>API</span> {apiVersion}
            </button>

            <div className={styles.heroBadge}>
              <span className={styles.badgeLabel}>Build</span> {buildTime}
            </div>

            <div className={styles.heroBadge}>
              <span className={styles.badgeLabel}>Status</span> {t(`common.${auth.connectionStatus}_status`)}
            </div>
          </div>

          <div className={styles.heroActions}>
            <div className={styles.quickLinksMinimal}>
              <a href="https://github.com/router-for-me/CLIProxyAPI" target="_blank" rel="noopener noreferrer" className={styles.minimalLink} title={t('system_info.link_main_repo')}>
                <IconGithub size={20} />
              </a>
              <a href="https://github.com/router-for-me/Cli-Proxy-API-Management-Center" target="_blank" rel="noopener noreferrer" className={styles.minimalLink} title={t('system_info.link_webui_repo')}>
                <IconCode size={20} />
              </a>
              <a href="https://help.router-for.me/" target="_blank" rel="noopener noreferrer" className={styles.minimalLink} title={t('system_info.link_docs')}>
            ...
            <Button variant="ghost" size="sm" onClick={handleClearLoginStorage} className={styles.dangerTextBtn}>
