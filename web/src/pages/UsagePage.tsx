...
export function UsagePage() {
  ...
  // Tab & Chart lines state
  type UsageTabId = 'overview' | 'charts' | 'details' | 'events' | 'configure';
  const TABS: { id: UsageTabId; labelKey: string; defaultLabel: string }[] = [
    { id: 'overview', labelKey: 'usage_stats.tab_overview', defaultLabel: 'Overview' },
    { id: 'charts', labelKey: 'usage_stats.tab_charts', defaultLabel: 'Charts' },
    { id: 'details', labelKey: 'usage_stats.tab_details', defaultLabel: 'Insights' },
    { id: 'events', labelKey: 'usage_stats.tab_events', defaultLabel: 'Events' },
    { id: 'configure', labelKey: 'usage_stats.tab_configure', defaultLabel: 'Settings' }
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Stats Overview Hero section - Always Visible */}
      <StatCards
        usage={filteredUsage}
        loading={loading}
      ...
      <div className={styles.tabContent}>
        ...
        {activeTab === 'charts' && (
          <div className={styles.chartsTabGrid}>
            <TokenBreakdownChart
              usage={filteredUsage}
              loading={loading}
              isDark={isDark}
        ...
        {activeTab === 'events' && (
          <div className={styles.eventsTabGrid}>
            <RequestEventsDetailsCard
              usage={filteredUsage}
              loading={loading}
        ...
        {activeTab === 'configure' && (
          <div className={styles.configureTabGrid}>
            <PriceSettingsCard
              modelNames={modelNames}
              modelPrices={modelPrices}
